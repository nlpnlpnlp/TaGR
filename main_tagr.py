...
from model import StudentTagRnpModel,TeacherEncoder
...
def parse_args():
    ...
    parser.add_argument('--seed',type=int,default=12252018, help='SEED')
    ...
    parser.add_argument('--graph_backbone', type=str, default='GAT') # GCN / SAGE / GIN / GAT /MLP
